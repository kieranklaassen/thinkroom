...
/**
 * The header's `⋯` document-options dialog — content layer over the shared
 * PopoverShell mechanics. Holds the secondary chrome (Panel/Focus toggles,
...
export function HeaderMenu({
  ...
  return (
    <PopoverShell
      rootClassName="share-root header-menu-root"
      popoverClassName="share-popover header-menu-popover"
      popoverLabel="Document options"
      trigger={({ open, toggle }) => (
        <button
