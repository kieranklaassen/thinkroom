module CompoundWriting
  ...
  # `subject` is the unit's own text, kept for the fake judge and for logging.
  Noul = Data.define(:instruction, :criteria, :subject, :reviewer_key, :question_id, :scope)
  ...
  module Prompts
    ...
    def phrase(question, reviewer, phrase)
      Noul.new(
        ...
        subject: phrase, reviewer_key: reviewer.key, question_id: question.id, scope: "phrase"
      )
    end
    ...
    def sentence(question, reviewer, sentence)
      Noul.new(
        ...
        subject: sentence, reviewer_key: reviewer.key, question_id: question.id, scope: "sentence"
      )
    end
    ...
    def paragraph(question, reviewer, paragraph)
      Noul.new(
        ...
        subject: paragraph, reviewer_key: reviewer.key, question_id: question.id, scope: "paragraph"
      )
    end
    ...
    def text(question, reviewer, text)
      Noul.new(
        ...
        subject: text, reviewer_key: reviewer.key, question_id: question.id, scope: "text"
      )
    end
  end
end
