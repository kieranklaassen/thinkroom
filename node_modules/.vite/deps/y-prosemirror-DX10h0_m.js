import { O as Slice, S as Fragment, a as PluginKey, c as TextSelection, i as Plugin, r as NodeSelection, t as AllSelection, w as Node } from "./dist-bQFOL9Wi.js";
import { n as DecorationSet, t as Decoration } from "./dist-BodulNsh.js";
import { $ as createRelativePositionFromTypeIndex, $t as toBase64, C as UndoManager, Dt as isDeleted, F as YXmlElement, J as createDeleteSet, L as YXmlFragment, N as YText, Ot as isParentOf, Q as createRelativePositionFromJSON, Qt as encodeAny, Sn as setIfUndefined, Ut as snapshot, V as applyUpdateV2, W as compareRelativePositions, Xt as timeout, Z as createID, Zt as doc, _ as Item, _n as max, an as oneOf, bn as create, bt as findIndexSS, en as isBrowser, et as createSnapshot, f as ContentString, hn as BIT30, kt as iterateDeletedStructs, ln as methodUnimplemented, m as Doc, nn as every, p as ContentType, q as createAbsolutePositionFromRelativePosition, qt as typeListToArraySnapshot, rn as keys, u as ContentFormat, un as unexpectedCase, vn as min, x as Snapshot, xn as create$1, xt as findRootTypeKey, y as RelativePosition, z as YXmlText } from "./yjs-BCoRhEGP.js";
...
var yXmlFragmentToProseMirrorFragment = (yXmlFragment, schema) => {
	const fragmentContent = yXmlFragment.toArray().map((t) => createNodeFromYElement(t, schema, createEmptyMeta())).filter((n) => n !== null);
...
var initProseMirrorDoc = (yXmlFragment, schema) => {
	...
	return {
		doc: schema.topNodeType.create(null, Fragment.fromArray(fragmentContent)),
		meta,
...
function prosemirrorToYXmlFragment(doc, xmlFragment) {
	...
	updateYFragment(type.doc ? type.doc : { transact: (transaction) => transaction(void 0) }, type, doc, {
		mapping: /* @__PURE__ */ new Map(),
		isOMark: /* @__PURE__ */ new Map()
	});
	return type;
...
function prosemirrorJSONToYDoc(schema, state, xmlFragment = "prosemirror") {
	return prosemirrorToYDoc(Node.fromJSON(schema, state), xmlFragment);
}
/**
...
function prosemirrorJSONToYXmlFragment(schema, state, xmlFragment) {
	return prosemirrorToYXmlFragment(Node.fromJSON(schema, state), xmlFragment);
}
/**
...
var yCursorPlugin = (awareness, { awarenessStateFilter = defaultAwarenessStateFilter, cursorBuilder = defaultCursorBuilder, selectionBuilder = defaultSelectionBuilder, getSelection = (state) => state.selection } = {}, cursorStateField = "cursor") => new Plugin({
	...
	state: {
		...
		apply(tr, prevState, _oldState, newState) {
			...
			if (ystate && ystate.isChangeOrigin || yCursorState && yCursorState.awarenessUpdated) return createDecorations(newState, awareness, awarenessStateFilter, cursorBuilder, selectionBuilder);
...
//#endregion
export { updateYFragment as A, yXmlFragmentToProseMirrorFragment as C, ProsemirrorBinding as D, yXmlFragmentToProsemirrorJSON as E, yCursorPluginKey as M, ySyncPluginKey as N, getRelativeSelection as O, yUndoPluginKey as P, yDocToProsemirrorJSON as S, yXmlFragmentToProsemirror as T, prosemirrorToYDoc as _, undo as a, setMeta as b, createDecorations as c, defaultSelectionBuilder as d, yCursorPlugin as f, prosemirrorJSONToYXmlFragment as g, prosemirrorJSONToYDoc as h, redoCommand as i, ySyncPlugin as j, isVisible as k, defaultAwarenessStateFilter as l, initProseMirrorDoc as m, defaultProtectedNodes as n, undoCommand as o, absolutePositionToRelativePosition as p, redo as r, yUndoPlugin as s, defaultDeleteFilter as t, defaultCursorBuilder as u, prosemirrorToYXmlFragment as v, yXmlFragmentToProseMirrorRootNode as w, yDocToProsemirror as x, relativePositionToAbsolutePosition as y };

//# sourceMappingURL=y-prosemirror-DX10h0_m.js.map