...
import { C as Mark, D as Schema, O as Slice$1, S as Fragment, _ as findWrapping, a as PluginKey, b as DOMParser, c as TextSelection, d as ReplaceAroundStep, f as ReplaceStep, h as canSplit, i as Plugin, m as canJoin, n as EditorState, o as Selection, r as NodeSelection, s as SelectionRange, t as AllSelection, v as liftTarget, w as Node, y as replaceStep } from "./dist-bQFOL9Wi.js";
import { r as EditorView } from "./dist-BodulNsh.js";
import "./view-Dps14kAO.js";
import { t as zwitch } from "./zwitch-CXpqUGp_.js";
	...
	if (canDelAfter && textblockAt(after, "start", true) && textblockAt(before, "end")) {
		...
		if (at.canReplace(at.childCount, at.childCount, afterText.content)) {
			if (dispatch) {
				...
				dispatch(state.tr.step(new ReplaceAroundStep($cut.pos - wrap.length, $cut.pos + after.nodeSize, $cut.pos + afterDepth, $cut.pos + after.nodeSize - afterDepth, new Slice$1(end, wrap.length, 0), 0, true)).scrollIntoView());
			}
			return true;
		}
	}
...
ie_upto10 ? document.documentMode : ie_11up ? +ie_11up[1] : ie_edge && +ie_edge[1];
!ie$1 && /gecko\/(\d+)/i.test(agent) && +(/Firefox\/(\d+)/.exec(agent) || [0, 0])[1];
var _chrome = !ie$1 && /Chrome\/(\d+)/.exec(agent);
var chrome = !!_chrome;
_chrome && +_chrome[1];
!ie$1 && nav && /Apple Computer/.test(nav.vendor) && (/Mobile\/\w+/.test(agent) || nav && nav.maxTouchPoints > 2) || nav && /Mac/.test(nav.platform);
var android = /Android \d/.test(agent);
doc && "webkitFontSmoothing" in doc.documentElement.style && +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1];
	...
	const plugin = new Plugin({
		...
		props: {
			...
			handleDOMEvents: {
				...
				keydown: (view, event) => {
					if (!(android && chrome && event.key === "Enter")) return false;
					if (view.composing) return false;
...
//#endregion
export { rootDOMCtx as $, getDoc as A, factorySpace as At, nodesCtx as B, combineExtensions as Bt, editorStateCtx as C, visit as Ct, editorViewCtx as D, blankLine as Dt, editorView as E, convert as Et, keymapCtx as F, markdownLineEndingOrSpace as Ft, pasteRulesCtx as G, ok$1 as Gt, parserCtx as H, types as Ht, keymapTimerCtx as I, markdownSpace as It, remarkCtx as J, ctxNotBind as Jt, pasteRulesTimerCtx as K, createSlice as Kt, markViewCtx as L, unicodePunctuation as Lt, initTimerCtx as M, asciiAlphanumeric as Mt, inputRulesCtx as N, asciiControl as Nt, editorViewOptionsCtx as O, resolveAll as Ot, keymap as P, markdownLineEnding as Pt, rootCtx as Q, missingYjsDoc as Qt, marksCtx as R, unicodeWhitespace as Rt, editorState as S, handle as St, editorStateTimerCtx as T, visitParents as Tt, parserTimerCtx as U, constants as Ut, parser as V, splice as Vt, pasteRule as W, codes as Wt, remarkStringifyOptionsCtx as X, missingMarkInSchema as Xt, remarkPluginsCtx as Y, expectDomTypeError as Yt, rootAttrsCtx as Z, missingNodeInSchema as Zt, commandsTimerCtx as _, wrappingInputRule as _t, EditorStateReady as a, serializerTimerCtx as at, defaultValueCtx as b, toggleMark as bt, InitReady as c, findNodeInSelection as ct, ParserReady as d, findSelectedNodeOfType as dt, schema as et, PasteRulesReady as f, getNodeFromSchema as ft, commandsCtx as g, textblockTypeInputRule as gt, commands as h, InputRule as ht, Editor as i, serializerCtx as it, init as j, asciiAlpha as jt, editorViewTimerCtx as k, classifyCharacter as kt, KeymapManager as l, findParentNodeClosestToPos as lt, SerializerReady as m, markRule as mt, CommandsReady as n, schemaTimerCtx as nt, EditorStatus as o, keydownHandler as ot, SchemaReady as p, isTextOnlySlice as pt, prosePluginsCtx as q, createTimer as qt, ConfigReady as r, serializer as rt, EditorViewReady as s, cloneTr as st, CommandManager as t, schemaCtx as tt, KeymapReady as u, findParentNodeType as ut, config as v, joinBackward as vt, editorStateOptionsCtx as w, SKIP as wt, editorCtx as x, wrapIn as xt, createCmdKey as y, setBlockType as yt, nodeViewCtx as z, normalizeIdentifier as zt };

//# sourceMappingURL=lib-DYUVwdOt.js.map