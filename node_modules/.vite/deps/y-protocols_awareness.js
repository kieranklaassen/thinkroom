import { cn as readVarUint, dn as createEncoder, fn as toUint8Array, gn as floor, in as getUnixTime, mn as writeVarUint, on as createDecoder, pn as writeVarString, sn as readVarString, tn as equalityDeep, yn as Observable } from "./yjs-BCoRhEGP.js";
...
var modifyAwarenessUpdate = (update, modify) => {
	...
	for (let i = 0; i < len; i++) {
		...
		const modifiedState = modify(JSON.parse(readVarString(decoder)));
		writeVarUint(encoder, clientID);
		writeVarUint(encoder, clock);
