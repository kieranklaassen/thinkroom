import { O as Slice, S as Fragment, a as PluginKey, c as TextSelection, i as Plugin, o as Selection, p as Transform, r as NodeSelection, s as SelectionRange } from "./dist-bQFOL9Wi.js";
import { n as DecorationSet, t as Decoration } from "./dist-BodulNsh.js";
import { At as factorySpace, Bt as combineExtensions, Dt as blankLine, Et as convert, Ft as markdownLineEndingOrSpace, Gt as ok, Ht as types, It as markdownSpace, Lt as unicodePunctuation, Mt as asciiAlphanumeric, Nt as asciiControl, Ot as resolveAll, Pt as markdownLineEnding, Rt as unicodeWhitespace, St as handle, Tt as visitParents, Ut as constants, Vt as splice, Wt as codes, Yt as expectDomTypeError, bt as toggleMark, g as commandsCtx, ht as InputRule, jt as asciiAlpha, kt as classifyCharacter, lt as findParentNodeClosestToPos, mt as markRule, ot as keydownHandler, st as cloneTr, ut as findParentNodeType, zt as normalizeIdentifier } from "./lib-DYUVwdOt.js";
import "./state-zbIakR44.js";
import { c as $markAttr, g as $prose, i as $inputRule, l as $markSchema, m as $pasteRule, p as $nodeSchema, t as $command, v as $remark, x as $useKeymap } from "./lib-C1HZ6Bri.js";
import { at as listItemSchema, ft as paragraphSchema } from "./lib-DMSFpEta.js";
...
* @internal
*/
function getCellsInRow$1(rowIndex, selection) {
	const table = findTable(selection.$from);
	if (!table) return;
	const map = TableMap.get(table.node);
...
function getSelectionRangeInColumn(tr, startColIndex, endColIndex = startColIndex) {
	...
	const firstRowCells = getCellsInRow$1(0, tr.selection);
...
function getSelectionRangeInRow(tr, startRowIndex, endRowIndex = startRowIndex) {
	...
	for (let i = startRowIndex; i >= 0; i--) {
		const cells = getCellsInRow$1(i, tr.selection);
		if (cells) cells.forEach((cell) => {
	...
	const indexes = [];
	for (let i = startIndex; i <= endIndex; i++) {
		const maybeCells = getCellsInRow$1(i, tr.selection);
		if (maybeCells && maybeCells.length > 0) indexes.push(i);
	}
	startIndex = indexes[0];
	endIndex = indexes[indexes.length - 1];
	const firstSelectedRowCells = getCellsInRow$1(startIndex, tr.selection);
	...
	let headCell;
	for (let i = endIndex; i >= startIndex; i--) {
		const rowCells = getCellsInRow$1(i, tr.selection);
...
//#endregion
//#region node_modules/prosemirror-safari-ime-span/dist/index.js
var nav = typeof navigator != "undefined" ? navigator : null;
var agent = nav && nav.userAgent || "";
var ie_edge = /Edge\/(\d+)/.exec(agent);
var ie_upto10 = /MSIE \d/.exec(agent);
var ie_11up = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(agent);
var safari = !!!(ie_upto10 || ie_11up || ie_edge) && !!nav && /Apple Computer/.test(nav.vendor);
...
//#endregion
//#region node_modules/@milkdown/preset-gfm/lib/index.js
...
//# sourceMappingURL=@milkdown_kit_preset_gfm.js.map