...
- **Files:** `app/frontend/styles/editor.css`, `app/frontend/editor/cursor_blocks.ts`, `app/frontend/editor/milkdown_editor.tsx`
- **Cites:** R1, R2, R5, R6, KTD2
- **Done when:** offscreen paragraphs compute `content-visibility: auto`, breakout blocks and cursor-holding blocks do not, and a peer's cursor label renders unclipped.
